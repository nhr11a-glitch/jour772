...
**Answer**
#The warning says "one or more parsing issues, call 'problems() on your data frame for details." When I follow its instructions, it shows me there are problems in 369 of the rows, explaining that in lieu of a numeric value it got a character. 
...
**Answer**
#I am not getting any parsing errors once we ran the codeblock using every row to set the data types. It's showing that it 5 of the columns we are getting character type information, and in the other three we get numeric values. 
```{r}
