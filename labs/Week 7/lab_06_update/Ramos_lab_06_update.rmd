...
**Write the answer:**
#Carroll had the most calls at 448, followed by Cecil at 438 and Allegany at 418. 
...
**Write answer here:**
#It seems like between the three countries, 911 calls peak during the summer, especially around August. Cecil County had 55 calls for August 22, the most out of the three counties. The three counties then trend mostly downwards for the rest of the year. Both Carroll and Cecil fall pretty significantly between August and September, which might be attributed to back to school transitions. Allegany, though, only decreased by one call between August and September.
...
#The location with the most calls (15) is 314 GROVE NECK RD EARLEVILLE, MD in Cecil County. That location is the inpatient facility RECOVERY CENTERS OF AMERICA AT BRACEBRIDGE HALL. Per their website, they serve "adults and young adults seeking help for substance use disorders."
...
```{r}
baltimore_911_with_demographics_under18 <- baltimore_911_with_demographics |>
  filter(plt18sp >= "75")|>
  group_by(zip_code, pop100) |>
  summarize(total=n())

baltimore_911_with_demographics_under18
```

Q3a: Where are those zip codes in the city?

**Write the answer here:**
#I created a quick Google map to visualize where they fall around the city [https://www.google.com/maps/@39.3022909,-76.655019,11z/data=!4m3!11m2!2sCxINLVqhSUyChr4kq1a8_Q!3e3?authuser=0&entry=ttu&g_ep=EgoyMDI1MTAxNC4wIKXMDSoASAFQAw%3D%3D]. 
#They seem to all be mostly around downtown Baltimore. 
...
```{r}
baltimore_911_with_demographics_under18 <- baltimore_911_with_demographics_under18 |>
  mutate(calls_per_1k = (total/pop100)*1000) |>
...
**Write the answer here:**
#Zip code 21217 has the highest rate of calls, rounded up to to 21 per 1,000 people.

#I focused on the three neighborhoods within zip code 21217 that had the highest rate of calls and are all located in west Baltimore. 

#Unfortunately when you Google Penn North, the first couple of articles that pop up detail a "mass overdose" that occurred earlier this month. CBS states this is the third mass overdoes in the community within the past four months. Additionally, they write, "In July, a total of 32 people were hospitalized after two mass overdoses were reported in the Penn North neighborhood." [https://www.cbsnews.com/baltimore/news/10-hospitalized-after-mass-overdose-penn-north/]

#Sandtown-Winchester was the home of Freddie Gray, who died from injuries while in police custody in 2015. An article by WYPR says that while the neighborhood was promised more city resources and investment in the wake of Gray's death, they are still struggling with childhood poverty, vacant homes, and lack of business and state investment. [https://www.wypr.org/wypr-news/2025-05-06/a-decade-after-the-baltimore-uprising-whats-changed-in-sandtown-winchester]

#Upton seems to be a community that is recieving some, if not the most of the three west Baltimore neighborhoods with respect to investment and redevelopment. The historic neighborhood has benefitted from attention from the Baltimore's city economic strategy. It seems like momentum has come in part from the Upton Planning Committee, which has been active for more than 40 year and rasks itself "with a purpose of trying to halt and reverse the decline in quality of life that many urban neighborhoods faced in recent years." UPC's website also mentions several prominent civil rights leaders who were residents or frequented the area, included Thurgood Marshall, W.E. Dubois and Booker T. Washington. [https://historicupton.com/about-us/]
