...
#There are 3,822 rows and four columns. 
...
#The "label=TRUE" turns the month as a number into the month denoted by their calendar name. 
...
#I see a blank, grey box below when I run the code. 
...
#I now see a bar chart with an x axis (month) and a y axis (count). The 12 months of call data and total call count are ordered chronologically. The y axis includes 0-300. 
...
#We have now reordered the months and total calls. Before, the months and total calls were ordered chronologically by month. Now, the months and total calls are organized in an ascending order by total calls. 
...
#The code below flipped the bar chart
