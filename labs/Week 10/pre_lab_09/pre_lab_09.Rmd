...
#The url is as follows: <https://datawrapper.dwcdn.net/1YOpw/1/>
...
md_gov_county <- md_gov_county |>
    mutate( total_votes = Cox + Moore + Lashar + Wallace,  pct_moore = round((Moore/total_votes)*100,1))|>
...
#By changing the tooltip from fips_code to county, we are able to see the counties when we hover over the map, as opposed to the fips_code. 

#I did not have to include the {{ FORMAT(pctmoore, "00.0%")}} because we had already rounded the percentages in R prior to uploading the csv to Datawrapper. If we didn't then adding that command would format the data to percentages rounded to one decimal point. 
...
**Answer Here** Put the URL of your map here.

#The URL is as follows: <https://datawrapper.dwcdn.net/CqYRo/2/>.
